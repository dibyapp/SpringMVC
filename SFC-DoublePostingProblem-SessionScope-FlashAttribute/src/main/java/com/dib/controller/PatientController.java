...
public class PatientController
{
	...
	public String processForm(RedirectAttributes model, @ModelAttribute("patCmd")PatientCommand cmd, BindingResult br) {
		...
		model.addFlashAttribute("resMsg", result); //it will keep in session scope where addAttribute will keep in request scope.
	...
	public String showResultPage() {
		System.out.println("PatientController.showResultPage()");
