...
public class PatientController
{
	...
	public String processForm(HttpSession session, @ModelAttribute("patCmd")PatientCommand cmd, BindingResult br) {
		...
		session.setAttribute("resMsg", result);
		session.setAttribute("sysDate", new Date());
